...
* `replace`: A map, each key being a pattern, whose value will be its replacements. `pattern` can be a string or a [regular expression](https://hexdocs.pm/elixir/Regex.html)
